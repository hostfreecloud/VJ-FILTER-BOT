...
API_ID = int(environ.get('API_ID', '1615127'))
API_HASH = environ.get('API_HASH', '566474478c929ad4bd441c0bd269531c')
BOT_TOKEN = environ.get('BOT_TOKEN', "6318429756:AAHKYzltAqO9K2pjG2739liar-4k_eBGOmU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '712573408').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009900687').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '966092421').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Zorox:Hostfreecloud@cluster0.qhicnr1.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Zoroxto")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'zorox_files')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/zorotogp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/shortlinks4u')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002093432457'))
...
URL = "https://zoroxbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://zoroxbot.onrender.com/".format(FQDN, PORT)
